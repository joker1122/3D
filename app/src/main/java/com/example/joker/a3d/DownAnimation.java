...
public class DownAnimation extends BaseAnimation {
    @Override
    public void setAnimator(View correct, View next) {
        ...
        PropertyValuesHolder correctDegree = PropertyValuesHolder.ofFloat("rotationX", 360, 270);
        PropertyValuesHolder nextDegree = PropertyValuesHolder.ofFloat("rotationX", 270, 180);
